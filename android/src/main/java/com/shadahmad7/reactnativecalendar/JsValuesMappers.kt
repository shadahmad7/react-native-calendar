...
// 🔹 Reminders
fun reminderStringMatchingConstant(constant: Int): String =
    when (constant) {
...
fun reminderConstantMatchingString(string: String?): Int =
    when (string) {
...
fun calendarAllowedRemindersFromDBString(dbString: String): ArrayList<String> {
    val array = ArrayList<String>()
    dbString.split(",").forEach { constant ->
        try {
...
// 🔹 Availabilities
fun calendarAllowedAvailabilitiesFromDBString(dbString: String): ArrayList<String> {
    val availabilitiesStrings = ArrayList<String>()
    dbString.split(",").forEach { availabilityId ->
...
fun availabilityStringMatchingConstant(constant: Int): String =
    when (constant) {
...
fun availabilityConstantMatchingString(string: String): Int =
    when (string) {
...
// 🔹 Access Levels
fun accessStringMatchingConstant(constant: Int): String =
    when (constant) {
...
fun accessConstantMatchingString(string: String): Int =
    when (string) {
...
// 🔹 Calendar Access
fun calAccessStringMatchingConstant(constant: Int): String =
    when (constant) {
...
fun calAccessConstantMatchingString(string: String): Int =
    when (string) {
...
fun attendeeRelationshipStringMatchingConstant(constant: Int): String =
    when (constant) {
...
fun attendeeRelationshipConstantMatchingString(string: String): Int =
    when (string) {
...
// 🔹 Attendee Type
fun attendeeTypeStringMatchingConstant(constant: Int): String =
    when (constant) {
...
fun attendeeTypeConstantMatchingString(string: String): Int =
    when (string) {
...
fun calendarAllowedAttendeeTypesFromDBString(dbString: String): ArrayList<String> {
    val array = ArrayList<String>()
    dbString.split(",").forEach { constant ->
        try {
...
// 🔹 Attendee Status
fun attendeeStatusStringMatchingConstant(constant: Int): String =
    when (constant) {
...
fun attendeeStatusConstantMatchingString(string: String): Int =
    when (string) {
